...
void ggml_cuda_mul_mat_vec_q(
    ...
    const auto recurrent_island = ctx.recurrent_norm_scale_islands.find(src1);
    if (recurrent_island != ctx.recurrent_norm_scale_islands.end()) {
        GGML_ASSERT(ne10 == 5120 && ne11 == 1 && ne12 == 1 && ne13 == 1);
        src1_q8_1_d = static_cast<char *>(recurrent_island->second.q8_1);
    } else if (ctx.shared_q8_1_inputs.find(src1) != ctx.shared_q8_1_inputs.end()) {
        src1_q8_1_d = static_cast<char *>(src1->data);
    } else {
