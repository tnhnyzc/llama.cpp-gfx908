...
extern "C" {
    ...
    struct llama_model_params {
        ...
        // optional expert-axis distribution for routed MoE weights in tensor split mode;
        // NULL uses tensor_split. Size: llama_max_devices()
        const float * expert_tensor_split;
